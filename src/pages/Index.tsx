      ...
      <section id="детали" className="py-20 px-6 bg-petal/40">
        <Section className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: "Church" as IconName, time: "14:00", title: "Церемония", place: "Усадьба «Белый сад»", desc: "Регистрация брака и венчание. Просим занять места за 15 минут до начала." },
              { icon: "Utensils" as IconName, time: "16:00", title: "Фуршет и фотосессия", place: "Сад усадьбы", desc: "Лёгкие закуски, игристое и прекрасные снимки в цветущем саду." },
              { icon: "Music" as IconName, time: "18:00", title: "Торжественный ужин", place: "Большой зал", desc: "Живая музыка, танцы, тосты и незабываемые мгновения с близкими." },
              { icon: "Sparkles" as IconName, time: "23:00", title: "Фейерверк", place: "Терраса усадьбы", desc: "Финальный аккорд нашего праздника — сверкающий салют над ночным садом." },
            ].map((item, idx) => (
